package br.com.strn.ec.util.thymeleaf.cdi;
 ...
 *
 * The variables are enumerated eagerly upon context initialization, but their values are only queried upon use. This
 * should be enough to prevent unnecessary instantiation of beans that are available to, but not actually referenced in,
 * the current view.
 *
